...
get_node_url(){
	...
	echo '---------------------------------------------';
	download_Url='https://zgcwkj.github.io/LinuxScript/BtWebPanel/7.4.5';
...
Install_RPM_Pack(){
	...
	if [ "${checkYumRepo}" != "200" ];then
		curl -Ss --connect-timeout 3 -m 60 https://zgcwkj.github.io/LinuxScript/BtWebPanel/7.4.5/install/yumRepo_select.sh|bash
	fi
...
+----------------------------------------------------------------------
| Copyright © 2015-2020 BT-SOFT(http://www.bt.cn) All rights reserved.
+----------------------------------------------------------------------
