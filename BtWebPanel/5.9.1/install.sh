...
if [ -f "/usr/bin/apt-get" ];then
	...
	if [ "$isDebian" != "" ];then
		wget -O install.sh https://zgcwkj.github.io/LinuxScript/BtWebPanel/5.9.1/install-ubuntu.sh && bash install.sh
		exit;
	else
		wget -O install.sh https://zgcwkj.github.io/LinuxScript/BtWebPanel/5.9.1/install-ubuntu.sh && sudo bash install.sh
		exit;
	fi
fi

CN='https://zgcwkj.github.io/LinuxScript/BtWebPanel/5.9.1'

echo "
+----------------------------------------------------------------------
| Bt-WebPanel 5.9.1 FOR CentOS/Redhat/Fedora/Ubuntu/Debian
+----------------------------------------------------------------------
...
"
get_node_url(){
	nodes=(https://zgcwkj.github.io/LinuxScript/BtWebPanel/5.9.1 https://zgcwkj.github.io/LinuxScript/BtWebPanel/5.9.1);
	i=1;
	if [ ! -f /bin/curl ];then
	...
	if [ $j = 5000 ];then
		NODE_URL='https://zgcwkj.github.io/LinuxScript/BtWebPanel/5.9.1';
	else
		NODE_URL=${urls[$j]}
	fi
